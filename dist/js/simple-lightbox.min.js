                  ...
                  this.createDomNodes(),
                    ...
                    this.options.disableRightClick &&
                      this.addEventListener(
                        ...
                        function (t) {
                          t.target.classList.contains("sl-overlay") &&
                            t.preventDefault();
                        }
                      ),
                  ...
                  (e = [
                    {
                      ...
                      value: function () {
                        (this.domNodes.overlay = document.createElement("div")),
                          ...
                          (this.domNodes.spinner = document.createElement(
                            "div"
                          )),
                          this.domNodes.spinner.classList.add("sl-spinner"),
                          (this.domNodes.spinner.innerHTML = "<div></div>"),
                          (this.domNodes.navigation = document.createElement(
                            "div"
                          )),
                          ...
                          (this.domNodes.wrapper = document.createElement(
                            "div"
                          )),
                          ...
                          t.addEventListener("load", function (t) {
                            ...
                            (r.domNodes.image.style.top =
                              ...
                              r.options.additionalHtml &&
                                ...
                                ((r.domNodes.additionalHtml = document.createElement(
                                  "div"
                                )),
                              ...
                              if ("mousedown" === t.type)
                                (o.controlCoordinates.initialPointerOffsetX =
                                  ...
                                  (o.controlCoordinates.initialPointerOffsetY =
                                    t.clientY),
                                  (o.controlCoordinates.containerHeight = o.getDimensions(
                                    o.domNodes.image
                                  ).height),
                                  (o.controlCoordinates.containerWidth = o.getDimensions(
                                    o.domNodes.image
                                  ).width),
                                  (o.controlCoordinates.imgHeight = o.getDimensions(
                                    o.currentImage
                                  ).height),
                                  (o.controlCoordinates.imgWidth = o.getDimensions(
                                    o.currentImage
                                  ).width),
                                  ...
                                  (o.controlCoordinates.initialOffsetX = parseFloat(
                                    o.currentImage.dataset.translateX
                                  )),
                                  (o.controlCoordinates.initialOffsetY = parseFloat(
                      ...
                      value: function (t) {
                        ...
                        t.dispatchEvent(
                          ...
                          this.options.disableScroll &&
                            (this.globalScrollbarWidth = this.toggleScrollbar(
                              "hide"
                            )),
